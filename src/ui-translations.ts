...
const enTranslations: Record<string, string> = {
    ...
    "扣税显示": "After Tax",
    "收益按扣税显示": "Display profit after tax",
    "效率单位": "Efficiency Unit",
    "切换效率统计单位": "Toggle efficiency calculation unit (min/hour)",
    "桌宠设置": "Notification Pet Settings",
    "快速操作": "Quick Actions",
    "开始记录": "Start Recording Data",
    "停止记录": "Stop Recording Data",
    "日志监听状态": "Log Listening Status",
    "服务状态": "Service Status",
    "运行中": "Running",
    "日志路径": "Log Path",
    "最后更新": "Last Updated",
